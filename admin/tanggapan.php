...
<div class="container mt-3" style="padding-left: 210px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-bs-toggle="modal" data-bs-target="#modalDetailTanggapan<?=$row['id_tanggapan'];?>"
                    ...
                    <p class="d-inline-block text-truncate" style="max-width: 300px;"><?=$row["tanggapan"]?>
                    </p>
                </td>
                ...
                <td class="text-center">
                    ...
                    <a class="btn btn-info text-light <?=$row['id_petugas'] !== $_SESSION['id_petugas'] ? 'disabled' : ''?>"
                        data-bs-toggle="modal" data-bs-target="#modalTanggap<?=$row['id_pengaduan'];?>">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php endif;?>
                </td>
    ...
    <!-- Modal verifikasi -->
    <?php foreach ( $getData as $row ): ?>
    <div class="modal fade" id="modalTanggap<?=$row['id_pengaduan'];?>" aria-hidden="true">
